...
from filtering_utils.ekfSLAM import EKFSLAM
...
class EKFSLAM:
    ...
    def marker_callback(self, msg):
        if self.initialized:
            ...
            cov.orientation.x = self.state[5]
            cov.orientation.y = self.state[6]
            pub2.publish(cov)
            ...
            pose.orientation.x = self.state[3]
            pose.orientation.y = self.state[4]
            pub.publish(pose)
